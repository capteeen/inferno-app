...
export default function CalidaTrade() {
  ...
  return (
    <div className="min-h-screen bg-black text-white">
      <style>{styles}</style>
      {/* Header */}
      <header className="fixed top-0 left-0 right-0 z-50 glass px-4 py-3 flex items-center justify-between border-b border-white/10">
        <div className="flex items-center gap-2">
          ...
          />
          <span className="text-xl font-bold">CalidaTrade</span>
        </div>
